      ...
      <div className="w-full max-w-sm space-y-8 px-6">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 space-y-5">
          <p className="text-sm text-slate-400 text-center">
            Acesse sua conta para ver seus alertas e configurar seus filtros.
          </p>

          <form action={signInWithGoogle}>
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white text-gray-800 font-medium text-sm rounded-xl hover:bg-gray-50 transition-colors shadow-sm"
            >
