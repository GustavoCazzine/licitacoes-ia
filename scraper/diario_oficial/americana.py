"""
Scraper do Diário Oficial de Americana, SP.

Portal: https://www.americana.sp.gov.br/diario-oficial/
Americana usa plataforma eDOM — as edições são listadas com links diretos para PDF.
"""
import re
import sys
...
_PORTAL_URL = "https://www.americana.sp.gov.br/diario-oficial/"
_HEADERS = {"User-Agent": "Mozilla/5.0 (compatible; licitacoes-ia/1.0)"}


class AmericanaScraper(BaseScraper):
    municipio = "Americana"
    uf = "SP"
    ...
    def buscar_edicoes(self, data: date) -> list[DiarioOficial]:
        ...
        links_pdf = _filtrar_links_pdf(soup, data, base_url="https://www.americana.sp.gov.br")
